...
- Grocy-CSV-Import per Browser-Upload aus CSV-Dateien oder ZIP-Archiv.

## 0.1.1

- White-Screen-Fix fuer Home-Assistant-Ingress.
- Doppelte Ingress-Slashes werden im Backend normalisiert.

## 0.1.0

- Erstes Home-Assistant-Add-on mit kombiniertem Frontend und Backend.
